package com.GPOslo.airbnbclone.service.auth;
...
class AuthServiceTest {
    ...
    public void signupDuplicateMember() {
        ...
        // 이미 존재하는 사용자 입니다.
        assertEquals("DUPLICATE_USER"
                , bizException.getBaseExceptionType().getErrorCode());
    }
    ...
    public void loginFailBecauseNotFoundEmail() {
        ...
        //then
        // 사용자를 찾을 수 없습니다.
        assertEquals(MemberExceptionType.NOT_FOUND_USER.getErrorCode()
                , bizException.getBaseExceptionType().getErrorCode());
    }
    ...
    public void loginFailBecauseEmptyPassword() {
        ...
        //then
        // 비밀번호를 입력해주세요.
        assertEquals(MemberExceptionType.NOT_FOUND_PASSWORD.getErrorCode()
                , bizException.getBaseExceptionType().getErrorCode());
    }
    ...
    public void loginFailBecauseWrongPassword() {
        ...
        //then
        // 비밀번호를 잘못 입력하였습니다.
        assertEquals(MemberExceptionType.WRONG_PASSWORD.getErrorCode()
                , bizException.getBaseExceptionType().getErrorCode());
